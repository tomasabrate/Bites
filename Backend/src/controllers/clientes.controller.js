...
export const postCliente = async (req, res) => {
  const { uid_cliente, mail, nombre, apellido, fecha_nacimiento, domicilio, telefono, preferencias_alimentarias, foto_perfil
  } = req.body;
  ...
  try {
    const [rows] = await pool.query(
      ...
      [ uid_cliente, mail, nombre, apellido, fecha_nacimiento, domicilio, telefono, preferencias_alimentarias, foto_perfil ]
    );
